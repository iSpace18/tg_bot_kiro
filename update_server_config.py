...
# New config content
config_content = '''from pydantic import BaseModel, field_validator
...
print("=== Update config.py on server ===")
# Write new config
stdin, stdout, stderr = client.exec_command("cat > /root/vpn_telegram/bot/config.py")
