...
print("\n=== Use the image that had aiosqlite (391e05507896) ===")
run("docker tag 391e05507896a7ddb9e5c151f5bbe2e016751f7a81272a2d2050b2b4deb99642 vpn_telegram-bot:working")
...
print("\n✅ Using working image with aiosqlite")
client.close()