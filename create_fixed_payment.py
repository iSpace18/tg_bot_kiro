...
# Полностью исправленный payment handler для синхронного SQLite
payment_content = '''import logging
...
from bot.keyboards.main import plans_keyboard, payment_method_keyboard, yookassa_pay_keyboard
...
print("\n🎉 Payment handler fixed! Test all buttons now!")
